...
class ultrasonic_sound_algorithm(object):
    ...
    def __init__(self, RATE = 192000 , BLOCKING_LOW_FREQUENCY = 0, BLOCKING_HIGH_FREQUENCY = 0, SHIFT_FREQUENCY = 0, OUTPUT_ADD_SINEWAVE = False, SINE_WAVE_VOLUME = 0.65, INPUT_DEVICE_INDEX = sd.default.device[0],  OUTPUT_DEVICE_INDEX = sd.default.device[1]): # Default Setting_ Values 
        ...
        self.win = pg.GraphicsWindow(title="Ultrasonic Sound Algorithm Equalizer")   ### win 이것이 문제다
        self.win.resize(500, 780)       
...
if __name__ == '__main__': 
    Enter_INPUT_DEVICE_INDEX =  3  # sd.default.device[0]
    # Default input_index를 입력
    Enter_OUTPUT_DEVICE_INDEX = sd.default.device[1]
    # Default output_index를 입력 

    ultrasonic_sound = ultrasonic_sound_algorithm(RATE = 192000, BLOCKING_LOW_FREQUENCY = 500, BLOCKING_HIGH_FREQUENCY = 7000, SHIFT_FREQUENCY = 30000, OUTPUT_ADD_SINEWAVE = True, SINE_WAVE_VOLUME = 0.65,  INPUT_DEVICE_INDEX = Enter_INPUT_DEVICE_INDEX ,  OUTPUT_DEVICE_INDEX = Enter_OUTPUT_DEVICE_INDEX)  # unit = Hz 
